...
def parse_arguments():
    ...
    parser.add_argument("-gplc", "--get_product_list_by_category_id", help="""  Get product list by category_id
        """, default="")
    ...
    parser.add_argument("-gpsl", "--get_products_subst_list", help="""  Get product subsitute list by id
        """, default="0")
    parser.add_argument("-gplm", "--get_products_list_by_match", help="""  Get product by match on key words
